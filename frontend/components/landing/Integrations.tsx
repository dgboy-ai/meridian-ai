...
const tools = [
  ...
  { name: 'REST addStructuredProperties', purpose: 'AI Knowledge panel on entities', type: 'write' },
  { name: 'REST raise_incident', purpose: 'Create incidents via DataHub API', type: 'write' },
  { name: 'GraphQL batch_add_tags', purpose: 'Tag all affected assets in bulk', type: 'write' },
  { name: 'REST update_incident_status', purpose: 'Close/resolved incidents', type: 'write' },
