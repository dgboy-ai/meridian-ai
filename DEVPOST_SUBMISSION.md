...
- **563 tests** (unit, integration, e2e) — CI on Python 3.11/3.12/3.13
...
| Testing | 563 tests (pytest + pytest-asyncio) |

## Links

- **GitHub:** https://github.com/dgboy-ai/meridian-ai
- **Demo:** https://meridian-ai.onrender.com (hosted on Render)
- **Video:** https://youtu.be/meridian-ai-demo (public YouTube link — see VIDEO_SCRIPT.md for the script)
